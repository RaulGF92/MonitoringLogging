...
public class MonitoringLogUILogger extends UDPLogger {

	Logger logger = LoggerFactory.getLogger(MonitoringLogUILogger.class);
	private String applicationIdentificator;
	
	public MonitoringLogUILogger(MonitoringLogUIConfiguration configuration) throws SocketException, UnknownHostException {
		super(configuration);
		this.applicationIdentificator = this.generateApplicationIdentificator(configuration.applicationName);
		logger.info("------------------------------------------------------------------------------------------------------");
		logger.info("The MonitoringLogUILogger was created, the application was loaded with name " + applicationIdentificator);
